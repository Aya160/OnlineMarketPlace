...
namespace OnlineStore.Infrastructure.Migrations
{
    ...
    [Migration("20240622155314_CreateDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineStore.Core.Entities.StoreEntity.SaleCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineStore.Core.Entities.StoreEntity.SaleProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineStore.Core.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineStore.Core.Entities.StoreEntity.Product", b =>
                {
                    ...
                    b.HasOne("OnlineStore.Core.Entities.StoreEntity.SaleProduct", "SaleProduct")
                        .WithMany("Products")
